        ...
        <HeadlessUiModal.BorderedContent className="bg-dark-1000/40 border !border-dark-800 rounded-2xl">
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Typography variant="lg" weight={700} className="text-info">
      ...
      {showAcceptChanges && (
        <HeadlessUiModal.BorderedContent className="border !border-dark-800">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outlined" size="xs" color="primary" onClick={onAcceptChanges}>
              {i18n._(t`Accept`)}
            </Button>
          </div>
        </HeadlessUiModal.BorderedContent>
      ...
      <div className="justify-start py-2 text-sm text-center text-secondary">
        {trade?.tradeType === TradeType.EXACT_INPUT ? (
          <Typography variant="xs" className="text-secondary">
            ...
            <Typography variant="xs" className="text-info" weight={700} component="span">
