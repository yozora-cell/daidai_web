    ...
    <div className="flex flex-col gap-4">
      ...
      <HeadlessUiModal.BorderedContent className="flex gap-3 px-3 bg-dark-900">
        ...
        <div className="flex flex-col gap-1">
          <Typography variant="h3" className={value ? 'text-base-content' : 'text-secondary'} weight={700}>
      ...
      {/* <TridentApproveGate inputAmounts={[valueCA]} tokenApproveOn={bentoboxContract?.address}>
        {({ approved, loading }) => {
          ...
          return (
            <Button loading={attemptingTxn || loading} color="primary" disabled={disabled} onClick={execute}>
