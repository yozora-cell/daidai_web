    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="z-10 flex justify-center -mt-6 -mb-6">
        <div className="p-1.5 rounded-full bg-dark-800 border border-dark-800 shadow-md border-dark-700">
          <ArrowDownIcon width={14} className="text-base-content" />
        </div>
      </div>
      <HeadlessUiModal.BorderedContent className="flex gap-3 px-3 bg-dark-900">
        ...
        <div className="flex flex-col gap-1">
          <Typography variant="h3" className={inputState.value ? 'text-base-content' : 'text-secondary'} weight={700}>
      ...
      <Button loading={attemptingTxn} color="default" disabled={disabled} onClick={execute}>
        <Typography variant="sm" weight={700} className={!error ? 'text-base-content' : 'text-low-emphasis'}>
          {buttonText}
        </Typography>
      </Button>
    </div>
