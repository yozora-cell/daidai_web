...
const Page = ({ loadData }: { loadData: (nfts: SlotsNFT[], tokens: SlotsToken[]) => void }) => {
  ...
  const bg = '/images/gacha/background.png'
  const congratulation = '/images/gacha/congratulation.png'
  const daidai_font = '/images/gacha/daidai_font.png'
  const gacha_font = '/images/gacha/gacha_font.png'
  const gacha_machine = '/images/gacha/gacha_machine.png'
  ...
  const curTicket: GachaSignature | undefined = useMemo(() => {
    if (
      ticketData &&
      ticketData.data &&
      ticketData.data.data &&
        ...
        <div className="container flex flex-col px-6 py-24">
          <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
            <div className="flex flex-col gap-4">
              {/**285 79 */}
              <div className="md:w-[228px] md:h-[63px] relative w-[159.6px] h-[44.1px]">
                <Image src={daidai_font} alt="img" layout="fill" className="object-cover" />
              </div>
              {/**540 65 */}
              <div className="md:w-[432px] md:h-[52px] relative w-[302.4px] h-[36.4px]">
                <Image src={gacha_font} alt="img" layout="fill" className="object-cover" />
              </div>
              <div className="md:w-[594px] md:p-6 mt-8 border-8 border-white border-dashed rounded-3xl w-[300px] p-4 gap-4 flex-col flex">
                ...
                <div className="flex flex-row items-center gap-4">
                  ...
                  <Typography className="text-[#FF6C7D] md:text-4xl text-1xl" weight={700}>
                    {i18n._(t`NFTS`)}
                  </Typography>
                </div>
                <div className="flex flex-row items-center gap-4">
                    ...
                    {isBingo ? (
                      ...
                      <>
                        <div className="flex flex-col items-center w-full py-4 border-b">
                          <Typography>{i18n._(t`You have drawn no prize, `)}</Typography>
                          <Typography>{i18n._(t`Try Another 10 TIMES!`)}</Typography>
                        </div>
                        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
