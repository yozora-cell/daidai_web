...
export interface UserState {
  // user sign token
  authToken: { [address: string]: string | null }
...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(updateAuthToken, (state, action) => {
      // console.log('updateAuthToken', action)
      if (state.authToken == undefined) {
        state.authToken = initialState.authToken
      }
      state.authToken[action.payload.account.toLowerCase()] = action.payload.authToken
    })
)
