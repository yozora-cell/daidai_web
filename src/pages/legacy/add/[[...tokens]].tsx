...
export default function Add() {
  ...
  // console.log('useDerivedMintInfo', error)
  ...
  const ModalHeader = noLiquidity ? (
    ...
    <div className="pb-4">
      <div className="flex items-center justify-start gap-3">
        <div className="text-xl font-bold md:text-3xl text-info">{liquidityMinted?.toSignificant(6)}</div>
        <div className="grid grid-flow-col gap-2">
          {/*@ts-ignore TYPE NEEDS FIXING*/}
          <DoubleCurrencyLogo currency0={currencyA} currency1={currencyB} size={48} />
        </div>
      </div>
      <div className="text-lg font-medium md:text-2xl text-info">
        {currencies[Field.CURRENCY_A]?.symbol}/{currencies[Field.CURRENCY_B]?.symbol}
        ...
        <DoubleGlowShadow>
          <div className="p-4 space-y-4 border rounded bg-base-100" style={{ zIndex: 1 }}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div>
                ...
                <AutoColumn justify="space-between" className="py-2.5">
                  <AutoRow justify={isExpertMode ? 'space-between' : 'flex-start'} style={{ padding: '0 1rem' }}>
                    <button className="z-10 -mt-6 -mb-6 rounded-full cursor-default bg-base-200 p-3px">
              ...
              {addIsUnsupported ? (
                <Button color="default" size="lg" disabled>
