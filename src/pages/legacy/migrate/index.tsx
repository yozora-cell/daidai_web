  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-center text-low-emphesis">
        {i18n._(
          t`Your ${exchange} ${state.selectedLPToken.tokenA.symbol}/${state.selectedLPToken.tokenB.symbol} liquidity will become DAIDAI ${state.selectedLPToken.tokenA.symbol}/${state.selectedLPToken.tokenB.symbol} liquidity.`
        )}
      </div>
    </div>
  )
...
export default function Migrate() {
  ...
  return (
    <Container id="migrate-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Migrate | DAIDAI</title>
        <meta key="description" name="description" content="Migrate your liquidity to DAIDAI." />
        <meta key="twitter:description" name="twitter:description" content="Migrate your liquidity to DAIDAI." />
        <meta key="og:description" property="og:description" content="Migrate your liquidity to DAIDAI." />
      </Head>
      ...
      {!account ? (
        <Web3Connect className="w-full !bg-dark-900 bg-gradient-to-r from-pink/80 hover:from-pink to-purple/80 hover:to-purple text-primary h-[38px]" />
      ) : (
