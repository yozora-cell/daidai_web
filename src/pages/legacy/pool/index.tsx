...
export default function Pool() {
  ...
  return (
    <Container id="pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Pool | DAIDAI</title>
        <meta
          key="description"
          name="description"
          content="DAIDAI liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
        <meta
      ...
      {!account ? (
        ...
        <div className="p-4 space-y-4 border rounded bg-base-100">
          <div className="grid grid-flow-row gap-3">
            {loading ? (
              ...
              <Empty className="flex text-lg text-center text-primary">
