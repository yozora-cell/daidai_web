  ...
  return (
    <Container id="find-pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      ...
      <Alert
        ...
        type="information"
      />
      <div className="relative p-4 space-y-4 rounded from-primary/5 to-info/5 bg-gradient-radial shadow-liquidity">
        <AutoColumn gap={'md'}>
          <CurrencySelectPanel
            currency={currency0}
        ...
        {currency0 && currency1 ? (
          ...
          <Web3Connect className="w-full" size="lg" color="primary" />
        ) : (
          prerequisiteMessage
        )}
