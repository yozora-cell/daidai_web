      ...
      <div className="grid gap-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="text-2xl font-bold text-info">{parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}</div>
          </div>
          <div className="ml-3 text-2xl font-medium text-info">{currencyA?.symbol}</div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="text-2xl font-bold text-info">{parsedAmounts[Field.CURRENCY_B]?.toSignificant(6)}</div>
          </div>
          <div className="ml-3 text-2xl font-medium text-info">{currencyB?.symbol}</div>
        </div>
      </div>
      ...
      {pair && (
        <>
          <div className="grid gap-1">
            <div className="flex items-center justify-between">
              <div className="text-sm text-info">{i18n._(t`Rates`)}</div>
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      ...
      <div className="px-4 mb-5">
        <NavLink href="/pool">
          <a className="flex items-center space-x-2 text-base font-medium text-center cursor-pointer text-secondary hover:text-info">
      ...
      <DoubleGlowShadow>
        <div className="p-4 space-y-4 border rounded bg-base-100" style={{ zIndex: 1 }}>
          {/* <AddRemoveTabs
          creating={false}
          adding={false}
            ...
            <AutoColumn gap="md">
              ...
              <div>
                ...
                <div
                  ...
                  className="p-5 mt-4 border rounded from-primary/5 to-info/5 bg-gradient-radial"
                >
                  <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
                    <div className="w-full text-primary sm:w-2/5" style={{ margin: 'auto 0px' }}>
                      <AutoColumn>
                    ...
                    <div className="flex flex-col space-y-3 md:flex-row md:space-x-6 md:space-y-0">
                      <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-dark-900">
                        ...
                        <AutoColumn>
                          <div className="truncate text-primary">{formattedAmounts[Field.CURRENCY_A] || '-'}</div>
                      ...
                      <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-dark-900">
                        ...
                        <AutoColumn>
                          <div className="truncate text-primary">{formattedAmounts[Field.CURRENCY_B] || '-'}</div>
              ...
              <div style={{ position: 'relative' }}>
                {!account ? (
                  <Web3Connect size="lg" color="primary" className="w-full" />
                ) : (
