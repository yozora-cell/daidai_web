  ...
  return (
    <div
      ...
      className={classNames(
        isActive ? 'text-base-content' : 'text-primary',
    ...
    >
      <div className="flex gap-3">
        ...
        <div className="flex flex-col">
          <Typography
            weight={700}
            className={classNames(isActive ? 'text-primary' : 'text-base-content', 'overflow-hidden overflow-ellipsis')}
          >
            {list.name}{' '}
          ...
          <div className="flex items-center gap-1">
              ...
              content={
                <div className="flex flex-col gap-1 p-3 border rounded shadow bg-dark-900 border-dark-700">
                  ...
                  <Typography
                    ...
                    className="cursor-pointer hover:text-primary disabled:cursor-default"
                  >
            ...
            >
              <Settings size={12} className="cursor-pointer text-base-content hover:text-primary" />
            </Popover>
          </div>
        </div>
      </div>
      <div>
        <Switch
          ...
          checkedIcon={<CheckIcon className="text-base-300" />}
  ...
  return (
    <>
      <input
        ...
        className="w-full p-4 text-base font-bold border rounded appearance-none border-base-300 hover:border-base-content placeholder-secondary"
        value={listUrlInput}
      ...
      <div className="h-full overflow-hidden overflow-y-auto rounded border-base-300 hover:border-base-content">
