    ...
    <>
      ...
      {showSearch && (
        <input
          ...
          className="w-full p-4 text-base font-bold border rounded appearance-none border-base-300 hover:border-base-content placeholder-secondary placeholder-opacity-70"
        />
      )}
      {showCommonBases && <CommonBases />}

      {searchToken && !searchTokenIsAdded && <ImportRow token={searchToken} onClick={handleImport} />}
      <div className="h-full overflow-hidden overflow-y-auto border rounded border-base-200 from-primary/5 to-info/5 bg-gradient-radial ">
