  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <HeadlessUiModal.BorderedContent className="flex flex-col items-center justify-center gap-1">
        ...
        <Typography variant="lg" weight={700} className="text-base-content">
          {pendingText}
        </Typography>
...
export const TransactionSubmittedContent: FC<TransactionSubmittedContentProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <HeadlessUiModal.BorderedContent className="flex flex-col items-center justify-center gap-1">
        <div className="w-[102px] h-[102px] bg-base-100 rounded-full">
          <Lottie animationData={receiptPrinting} autoplay loop={false} />
        </div>
        <Typography id="text-transaction-submitted" variant="sm" weight={700} className="text-base-content">
      ...
      {currencyToAdd && library?.provider?.isMetaMask && (
        <Button color="primary" onClick={!success ? addToken : onDismiss}>
