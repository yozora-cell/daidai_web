...
import * as BSCTEST from './tokens/bsctest'
...
// 对应Wallet对应的Assets，这里只能尽可能多的把现有的token加进来进行对应
export const WALLET_ASSETS: ChainTokenList = {
  [ChainId.ETHEREUM]: [
    // @ts-ignore TYPE NEEDS FIXING
    ...WRAPPED_NATIVE_ONLY[ChainId.ETHEREUM],
    // @ts-ignore TYPE NEEDS FIXING
...
// 配置INO支持的token 这里默认和NFTMarketplace一样
export const INO: ChainTokenList = {
  [ChainId.ETHEREUM]: [
    // @ts-ignore TYPE NEEDS FIXING
    ...WRAPPED_NATIVE_ONLY[ChainId.ETHEREUM],
    // @ts-ignore TYPE NEEDS FIXING
