...
> = {
  ...
  [ChainId.MATIC_TESTNET]: {
    ...
    rpcUrls: ['https://rpc-mumbai.matic.today'], // ['https://matic-mainnet.chainstacklabs.com/'],
...
const SWITCH_NETWORKS_TEMP = [ChainId.ETHEREUM, ChainId.MATIC, ChainId.BSC]

if (defaultChainId == ChainId.BSC_TESTNET) {
  SWITCH_NETWORKS_TEMP.push(ChainId.BSC_TESTNET)
}

// 切换网络时需要展示的网络清单
export const SWITCH_NETWORKS = SWITCH_NETWORKS_TEMP
