...
const AssetInput: AssetInput<AssetInputProps> = ({
  ...
  let header = (
    <Typography variant="h3" weight={700} className="text-base-content">
    ...
    header = (
      ...
      >
        <div className="flex gap-0.5 items-center">
          <Typography id={props.id} variant="h3" weight={700} className="text-base-content">
    ...
    content = (
      ...
      >
        ...
        {error ? (
          ...
          showMax && (
            <Button size="xs" variant="outlined" color="default" className="!border" onClick={() => onMax()}>
              Max
            </Button>
          )
        )}
...
const AssetInputPanelBalance: FC<AssetInputPanelBalanceProps> = ({ balance, onClick, spendFromWallet = true, id }) => {
  ...
  let icon = (
    <WalletIcon width={16} height={14} className={classNames(balance ? 'text-base-content' : 'text-low-emphesis')} />
  )
  if (!spendFromWallet) {
    icon = (
      <BentoboxIcon
        width={16}
        height={16}
        className={classNames(balance ? 'text-base-content' : 'text-low-emphesis', 'truncate')}
      />
    )
  }
  ...
  return (
    <div className={classNames(error ? 'bg-red/10' : '', 'flex justify-between py-2 px-3')}>
      <div className="flex items-center gap-1.5 mr-1">
        {icon}
        <Typography variant="sm" className={classNames(balance ? 'text-base-content' : 'text-low-emphesis')}>
          {i18n._(t`Balance:`)}
        </Typography>
      </div>
      <Typography
      ...
      <div className="flex items-center gap-3 lg:flex-col">
        <div className="flex flex-col order-1 lg:order-2">
          ...
          <Typography
            variant="sm"
            weight={700}
            className="text-right text-base-content lg:text-center lg:flex lg:gap-1 lg:items-center lg:justify-center"
          >
