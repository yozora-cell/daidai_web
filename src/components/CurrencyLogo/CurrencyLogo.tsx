...
export const getCurrencyLogoUrls = (currency: Currency): string[] => {
  ...
  if (currency.chainId in BLOCKCHAIN) {
    urls.push(`https://static.daidai.io/images/tokens/${currency.chainId}/${currency.wrapped.address}.png`)
    urls.push(`https://statictest.stars.finance/images/tokens/${currency.chainId}/${currency.wrapped.address}.png`)
    urls.push(
      // @ts-ignore TYPE NEEDS FIXING
