  ...
  return (
    <>
      <Popover
        ...
        content={
          <div className="flex flex-col gap-3 p-3 border rounded shadow-xl bg-base-100 w-80">
            ...
            <div className="flex flex-col gap-3 p-3 border rounded border-dark-800/60">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Typography variant="xs" className="text-base-content" weight={700}>
      ...
      >
        ...
        >
          <CogIcon className="w-[26px] h-[26px] transform rotate-90 hover:text-primary" />
        </div>
      </Popover>
