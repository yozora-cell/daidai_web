  ...
  return (
    <>
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, JSBI.BigInt(0)) ? (
        <div className="p-5 rounded from-primary/5 to-info/5 bg-gradient-radial text-base-content">
          <AutoColumn gap={'md'}>
            ...
            <div className="flex flex-col w-full p-3 mt-3 space-y-1 text-sm rounded bg-dark-900 text-base-content">
...
export default function FullPositionCard({ pair, border, stakedBalance }: PositionCardProps) {
  ...
  return (
    <div
      className="rounded from-primary/5 to-info/5 bg-gradient-radial"
      // style={{ backgroundColor }}
    >
      <Button
        variant="empty"
        className={classNames(
          'w-full px-4 py-6 cursor-pointer from-primary/5 to-info/5 bg-gradient-radial hover:bg-base-200 !h-auto',
          showMore && '!bg-base-200'
        )}
      ...
      >
        <div className="p-4 space-y-4">
          <div className="px-4 py-4 space-y-1 text-sm rounded text-base-content bg-dark-900">
