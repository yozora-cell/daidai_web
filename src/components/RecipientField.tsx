...
const RecipientField: FC<RecipientField> = ({ recipient, action }) => {
  ...
  return !use ? (
    <div className="flex justify-center">
      <Button size="xs" color="primary" variant="empty" className="flex gap-1 py-1.5" onClick={() => setUse(true)}>
    ...
    <div className="flex flex-col gap-1">
      <div className="flex justify-between">
        ...
        <CloseIcon width={18} className="cursor-pointer text-secondary hover:text-primary" onClick={handleClose} />
      </div>
      <div
