          ...
          <Popover.Button className={classNames(open ? 'text-secondary' : 'text-primary', 'focus:outline-none')}>
            <Image
              ...
              className={classNames(
                ...
                'inline-flex items-center ml-2 h-5 w-5 group-hover:text-secondary hover:text-base-content'
              )}
              alt="More"
              width={20}
              height={20}
              ...
              <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="relative grid gap-6 px-5 py-6 bg-dark-900 sm:gap-8 sm:p-8">
                  {solutions.map((item) => (
                    ...
                    >
                      <p className="text-base font-medium text-base-content">{item.name}</p>
