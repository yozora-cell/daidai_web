        ...
        <div className={classNames('w-full sm:w-2/5')}>
          <button
            ...
            className={classNames(
              !!currency ? 'text-primary' : 'text-base-content',
                  ...
                  <div className="flex items-center">
                    <div className="text-lg font-bold token-symbol-container md:text-2xl">
                      {(currency && currency.symbol && currency.symbol.length > 20
                        ...
                        : currency?.symbol) || (
                        <div className="px-2 py-1 mt-1 text-xs font-medium bg-transparent border rounded-full hover:bg-primary text-primary hover:text-base-100 whitespace-nowrap">
          ...
          >
            <>
              {showMaxButton && selectedCurrencyBalance && (
                <Button variant="outlined" color="primary" onClick={onMax} size="xs">
                  {i18n._(t`Max`)}
                </Button>
              )}
              <Input.Numeric
